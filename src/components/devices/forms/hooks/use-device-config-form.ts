import type { UseDeviceConfigFormProps } from '@components/devices/forms/hooks/use-device-config-form.types';
import { deviceConfigFormSchema } from '@components/devices/forms/validation/device-config-form.schema';
