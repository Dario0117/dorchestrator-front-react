...
import { createShortcutHandler } from '@services/terminal/create-shortcut.http-service.handlers';
import { deleteShortcutHandler } from '@services/terminal/delete-shortcut.http-service.handlers';
import { listShortcutsHandler } from '@services/terminal/list-shortcuts.http-service.handlers';
import { terminalWsClient } from '@services/terminal/terminal-ws.client';
import { updateShortcutHandler } from '@services/terminal/update-shortcut.http-service.handlers';
