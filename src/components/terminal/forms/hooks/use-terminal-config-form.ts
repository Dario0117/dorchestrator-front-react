...
import type { UseTerminalConfigFormProps } from '@components/terminal/forms/hooks/use-terminal-config-form.types';
import { terminalConfigFormSchema } from '@components/terminal/forms/validation/terminal-config-form.schema';
