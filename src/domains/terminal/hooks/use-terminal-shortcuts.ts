...
import { useCreateShortcutMutation } from '@domains/terminal/services/create-shortcut.http-service';
import { useDeleteShortcutMutation } from '@domains/terminal/services/delete-shortcut.http-service';
import {
  type ShortcutItem,
