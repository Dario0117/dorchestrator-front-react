...
- [ ] Configure a test command for claude code that uses the same structure as VITE_IS_VSCODE_DEBUG to disable parallel execution because it crashes the pc due to resource exhaustion
